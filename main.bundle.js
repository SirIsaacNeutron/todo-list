...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n    --header-bg: #9be8ff;\n    --sidebar-bg: rgb(227, 248, 255);\n    --header-padding: 30px;\n    --sidebar-button-pad: 10px;\n\n    --hover-bg-color: #e2e2e2;\n    --submit-btn-bg: #8afc8a;\n    --cancel-btn-bg: #fd5050;\n\n    --todo-padding: 10px;\n}\n\n* {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n}\n\nbody {\n    display: grid;\n    grid-template-rows: 1fr 7fr 0.5fr;\n    grid-template-columns: 1fr 4fr;\n\n    min-height: 100vh;\n}\n\nbutton {\n    outline: none;\n    border: none;\n    text-align: left;\n}\n\ninput:focus {\n    outline: none;\n}\n\nheader {\n    display: flex;\n    align-items: center;\n\n    background-color: var(--header-bg);\n\n    padding: 10px var(--header-padding);\n\n    grid-row: 1;\n    grid-column: 1 / -1;\n}\n\nnav {\n    background-color: var(--sidebar-bg);\n\n    grid-row: 2;\n    grid-column: 1;\n}\n\nnav button {\n    background-color: var(--sidebar-bg);\n\n    font-size: inherit;\n    padding: var(--sidebar-button-pad);\n\n    border-radius: 10px;\n\n    transition: all 150ms ease-in-out;\n}\n\nnav button:hover {\n    background-color:rgb(159, 231, 255);\n}\n\n.main-links {\n    display: flex;\n    flex-direction: column;\n    gap: 20px;\n\n    /* This should automatically align the button text in .main-links with the header text */\n    padding: 0 calc(var(--header-padding) - var(--sidebar-button-pad));\n    margin: 20px 0 5px;\n\n    font-size: 1.5rem;\n}\n\n.projects-header {\n    font-size: 1.6rem;\n\n    padding: var(--header-padding);\n}\n\nmain {\n    padding: 25px;\n\n    background-color: white;\n    grid-row: 2;\n    grid-column: 2 / -1;\n}\n\nmain h2 {\n    margin-bottom: 10px;\n}\n\n.todos {\n    display: flex;\n    flex-direction: column;\n\n    gap: 15px;\n}\n\n/* Todos */\n\n.todo {\n    background-color: #f4f4f4;\n    border-radius: 5px;\n    \n    display: flex;\n    align-items: center;\n    padding: var(--todo-padding);\n\n    transition: all 150ms ease-in-out;\n}\n\n.todo:hover {\n    transform: scale(1.005);\n    /* Shadow helps create a sense of popping out */\n    box-shadow: 3px 3px 5px 2px rgb(0 0 0 / .2);\n}\n\n.todo-title {\n    cursor: pointer;\n}\n\n.date {\n    margin-left: auto;\n    margin-right: 10px;\n\n    cursor: pointer;\n}\n\n.add-todo-btn {\n    border: 1px solid grey;\n    border-radius: 5px;\n\n    width: 100%;\n    background-color: white;\n\n    font-size: 1rem;\n\n    padding: var(--todo-padding);\n\n    transition: background-color 150ms ease-in-out;\n}\n\n.add-todo-btn:hover {\n    background-color: var(--hover-bg-color);\n}\n\n.add-todo-form input {\n    width: 100%;\n}\n\n/* Form */\n\n.add-todo-form input {\n    padding: var(--todo-padding);\n    font-size: 1rem;\n}\n\n.form-btns {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    gap: 30px;\n\n    margin-top: 10px;\n\n    width: 100%;\n}\n\n.form-btn {\n    padding: 10px 20px;\n    border-radius: 5px;\n    font-size: 1rem;\n}\n\n.submit-btn {\n    background-color: var(--submit-btn-bg);\n    \n    transition: background-color 150ms ease-in-out;\n}\n\n.submit-btn:hover {\n    background-color: #76d576;\n}\n\n.cancel-btn {\n    color: var(--cancel-btn-bg);\n\n    background: white;\n    border: 1px solid var(--cancel-btn-bg);\n\n    transition: all 150ms ease-in-out;\n}\n\n.cancel-btn:hover {\n    background-color: var(--cancel-btn-bg);\n    color: white;\n}\n\nfooter {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    gap: 10px;\n\n    background-color: var(--header-bg);\n\n    grid-column: 1 / -1;\n    padding: 15px;\n}\n\n.fa-github {\n    font-size: 24px;\n    color: black; /* prevent icon from going red on click */\n    transition: transform 0.3s ease-in-out;\n}\n\n.fa-github:hover {\n    transform: rotate(360deg) scale(1.2);\n}", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,oBAAoB;IACpB,gCAAgC;IAChC,sBAAsB;IACtB,0BAA0B;;IAE1B,yBAAyB;IACzB,wBAAwB;IACxB,wBAAwB;;IAExB,oBAAoB;AACxB;;AAEA;IACI,sBAAsB;IACtB,SAAS;IACT,UAAU;AACd;;AAEA;IACI,aAAa;IACb,iCAAiC;IACjC,8BAA8B;;IAE9B,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,YAAY;IACZ,gBAAgB;AACpB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,mBAAmB;;IAEnB,kCAAkC;;IAElC,mCAAmC;;IAEnC,WAAW;IACX,mBAAmB;AACvB;;AAEA;IACI,mCAAmC;;IAEnC,WAAW;IACX,cAAc;AAClB;;AAEA;IACI,mCAAmC;;IAEnC,kBAAkB;IAClB,kCAAkC;;IAElC,mBAAmB;;IAEnB,iCAAiC;AACrC;;AAEA;IACI,mCAAmC;AACvC;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,SAAS;;IAET,wFAAwF;IACxF,kEAAkE;IAClE,kBAAkB;;IAElB,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;;IAEjB,8BAA8B;AAClC;;AAEA;IACI,aAAa;;IAEb,uBAAuB;IACvB,WAAW;IACX,mBAAmB;AACvB;;AAEA;IACI,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,sBAAsB;;IAEtB,SAAS;AACb;;AAEA,UAAU;;AAEV;IACI,yBAAyB;IACzB,kBAAkB;;IAElB,aAAa;IACb,mBAAmB;IACnB,4BAA4B;;IAE5B,iCAAiC;AACrC;;AAEA;IACI,uBAAuB;IACvB,+CAA+C;IAC/C,2CAA2C;AAC/C;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,iBAAiB;IACjB,kBAAkB;;IAElB,eAAe;AACnB;;AAEA;IACI,sBAAsB;IACtB,kBAAkB;;IAElB,WAAW;IACX,uBAAuB;;IAEvB,eAAe;;IAEf,4BAA4B;;IAE5B,8CAA8C;AAClD;;AAEA;IACI,uCAAuC;AAC3C;;AAEA;IACI,WAAW;AACf;;AAEA,SAAS;;AAET;IACI,4BAA4B;IAC5B,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,SAAS;;IAET,gBAAgB;;IAEhB,WAAW;AACf;;AAEA;IACI,kBAAkB;IAClB,kBAAkB;IAClB,eAAe;AACnB;;AAEA;IACI,sCAAsC;;IAEtC,8CAA8C;AAClD;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,2BAA2B;;IAE3B,iBAAiB;IACjB,sCAAsC;;IAEtC,iCAAiC;AACrC;;AAEA;IACI,sCAAsC;IACtC,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,SAAS;;IAET,kCAAkC;;IAElC,mBAAmB;IACnB,aAAa;AACjB;;AAEA;IACI,eAAe;IACf,YAAY,EAAE,yCAAyC;IACvD,sCAAsC;AAC1C;;AAEA;IACI,oCAAoC;AACxC","sourcesContent":[":root {\n    --header-bg: #9be8ff;\n    --sidebar-bg: rgb(227, 248, 255);\n    --header-padding: 30px;\n    --sidebar-button-pad: 10px;\n\n    --hover-bg-color: #e2e2e2;\n    --submit-btn-bg: #8afc8a;\n    --cancel-btn-bg: #fd5050;\n\n    --todo-padding: 10px;\n}\n\n* {\n    box-sizing: border-box;\n    margin: 0;\n    padding: 0;\n}\n\nbody {\n    display: grid;\n    grid-template-rows: 1fr 7fr 0.5fr;\n    grid-template-columns: 1fr 4fr;\n\n    min-height: 100vh;\n}\n\nbutton {\n    outline: none;\n    border: none;\n    text-align: left;\n}\n\ninput:focus {\n    outline: none;\n}\n\nheader {\n    display: flex;\n    align-items: center;\n\n    background-color: var(--header-bg);\n\n    padding: 10px var(--header-padding);\n\n    grid-row: 1;\n    grid-column: 1 / -1;\n}\n\nnav {\n    background-color: var(--sidebar-bg);\n\n    grid-row: 2;\n    grid-column: 1;\n}\n\nnav button {\n    background-color: var(--sidebar-bg);\n\n    font-size: inherit;\n    padding: var(--sidebar-button-pad);\n\n    border-radius: 10px;\n\n    transition: all 150ms ease-in-out;\n}\n\nnav button:hover {\n    background-color:rgb(159, 231, 255);\n}\n\n.main-links {\n    display: flex;\n    flex-direction: column;\n    gap: 20px;\n\n    /* This should automatically align the button text in .main-links with the header text */\n    padding: 0 calc(var(--header-padding) - var(--sidebar-button-pad));\n    margin: 20px 0 5px;\n\n    font-size: 1.5rem;\n}\n\n.projects-header {\n    font-size: 1.6rem;\n\n    padding: var(--header-padding);\n}\n\nmain {\n    padding: 25px;\n\n    background-color: white;\n    grid-row: 2;\n    grid-column: 2 / -1;\n}\n\nmain h2 {\n    margin-bottom: 10px;\n}\n\n.todos {\n    display: flex;\n    flex-direction: column;\n\n    gap: 15px;\n}\n\n/* Todos */\n\n.todo {\n    background-color: #f4f4f4;\n    border-radius: 5px;\n    \n    display: flex;\n    align-items: center;\n    padding: var(--todo-padding);\n\n    transition: all 150ms ease-in-out;\n}\n\n.todo:hover {\n    transform: scale(1.005);\n    /* Shadow helps create a sense of popping out */\n    box-shadow: 3px 3px 5px 2px rgb(0 0 0 / .2);\n}\n\n.todo-title {\n    cursor: pointer;\n}\n\n.date {\n    margin-left: auto;\n    margin-right: 10px;\n\n    cursor: pointer;\n}\n\n.add-todo-btn {\n    border: 1px solid grey;\n    border-radius: 5px;\n\n    width: 100%;\n    background-color: white;\n\n    font-size: 1rem;\n\n    padding: var(--todo-padding);\n\n    transition: background-color 150ms ease-in-out;\n}\n\n.add-todo-btn:hover {\n    background-color: var(--hover-bg-color);\n}\n\n.add-todo-form input {\n    width: 100%;\n}\n\n/* Form */\n\n.add-todo-form input {\n    padding: var(--todo-padding);\n    font-size: 1rem;\n}\n\n.form-btns {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    gap: 30px;\n\n    margin-top: 10px;\n\n    width: 100%;\n}\n\n.form-btn {\n    padding: 10px 20px;\n    border-radius: 5px;\n    font-size: 1rem;\n}\n\n.submit-btn {\n    background-color: var(--submit-btn-bg);\n    \n    transition: background-color 150ms ease-in-out;\n}\n\n.submit-btn:hover {\n    background-color: #76d576;\n}\n\n.cancel-btn {\n    color: var(--cancel-btn-bg);\n\n    background: white;\n    border: 1px solid var(--cancel-btn-bg);\n\n    transition: all 150ms ease-in-out;\n}\n\n.cancel-btn:hover {\n    background-color: var(--cancel-btn-bg);\n    color: white;\n}\n\nfooter {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    gap: 10px;\n\n    background-color: var(--header-bg);\n\n    grid-column: 1 / -1;\n    padding: 15px;\n}\n\n.fa-github {\n    font-size: 24px;\n    color: black; /* prevent icon from going red on click */\n    transition: transform 0.3s ease-in-out;\n}\n\n.fa-github:hover {\n    transform: rotate(360deg) scale(1.2);\n}"],"sourceRoot":""}]);
// Exports
